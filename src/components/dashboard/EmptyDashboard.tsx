  ...
  return (
    <div className="text-center py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center shadow hover:shadow-lg transition-shadow cursor-pointer">
      ...
      <Button onClick={handleCreateNotebook} size="lg" className="bg-blue-600 hover:bg-blue-700 shadow-lg text-lg px-8 py-4 mt-4 transition-transform hover:scale-105" disabled={isCreating}>
